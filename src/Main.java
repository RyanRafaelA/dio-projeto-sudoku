...
public class Main {
        ...
        while(true){
            ...
            switch (option){
                ...
                case 8:
                    ...
                    break;
                default:
                    System.out.println("Opção invalida, selecione uma das opções do menu.");
            }
        }
    }
    ...
    private static void startGame(final Map<String, String> positions) {
        if(nonNull(board)){
            System.out.println("O jogo já iniciado");
            return;
        }
    ...
    private static void inputNumber() {
        ...
        System.out.println("Informe a coluna em que o numero ser inserido: ");
        var col = runUntilGetValidNumber(0, 8);
        System.out.println("Informe a linha em que o numero ser inserido: ");
    ...
    private static void showGameStatus() {
        ...
        if(board.hasError()){
            System.out.println("O jogo contem erro");
        } else {
            System.out.println("O jogo não contem erro");
        }
    }
    ...
    private static void clearGame() {
        ...
        System.out.println("Tem certeza de limpar seu jogo e perder todo seu progresso ");
        var confirma = sc.next();
